...
from object_ros_msgs.msg import BoundingBox, BoundingBoxes, RangeBearing, \
...
class SemanticSLAM():
    ...
    def range_callback(self, msg):
        ...
        file1 = open(os.path.join(os.path.dirname(__file__), "../../../new_offline_map5/") + str(self.time_id) +  ".txt", "w")
